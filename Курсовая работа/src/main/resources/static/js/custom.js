...
"footer": {
"add": true,
"title": "Copyrights 2021 Доставка продуктов. Все права защищены."
},
...
if(app_name.value == ""){
errors+= 'Пожалуйста напишите имя';
}
else if(app_email_address.value == ""){
errors+= 'Пожалуйста напишите Email';
}
else if(checkcontact(app_email_address.value) == false){
errors+= 'Пожалуйста проверьте написанный адрес электронной почты';
}		
